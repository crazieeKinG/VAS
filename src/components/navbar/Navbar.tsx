...
import { ADD_APPOINTMENT, ADD_PATIENT, ADD_VACCINATION, HOME, LIST_APPOINTMENT, LOGIN, LOGOUT, REGISTER_PATIENT, SCHEDULE_APPOINTMENT } from "../../constants/navLinkConstants";
